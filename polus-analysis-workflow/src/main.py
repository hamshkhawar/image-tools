...
parser.add_argument('--model', dest='model', type=str,
                        help='choose the pre-trained model for nuclear segmentation', required=True) 
...
def main(data:str,
        ...
        for plate in plates:
            ...
            segDir = polus_smp_training_inference(inpDir=corrDir, filePattern=filePattern, model=model, outDir=outDir,dryrun=False)
